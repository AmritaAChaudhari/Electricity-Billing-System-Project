...
public class Signup extends JFrame implements ActionListener {
    Choice loginAsCho;
    TextField meterText, employerText, userNameText, passwordText, nameText;
    JButton create, back;
    ...
    Signup() {
        ...
        create.setBackground(new Color(35, 217, 245));
        ...
        back.setBackground(new Color(35, 217, 245));
        back.setForeground(Color.white);
        back.setBounds(188, 285, 100, 25);
        back.addActionListener(this);
        add(back);

        ImageIcon registerIcon = new ImageIcon(ClassLoader.getSystemResource("icon/register.png"));
        Image registerImg = registerIcon.getImage().getScaledInstance(250, 250, Image.SCALE_DEFAULT);
        ImageIcon registerIcon2 = new ImageIcon(registerImg);
        JLabel registerLabel = new JLabel(registerIcon2);
        registerLabel.setBounds(320, 30, 250, 250);
        add(registerLabel);
